import sys
import pygame
from classes import Checkers, Color, Direction, Heuristics, Algorithm, K_VALUE
...
class CheckersUI:
    def __init__(self, PLAYER_COLOR_STR: str = 'w') -> None:
        ...
        self.bot_algo = Algorithm(heuristic.sum_and_doubling) 
    ...
    def process_bot_move(self) -> None:
        ...
        _, move = self.bot_algo.minmax(self.game, MAX_DEPTH)
